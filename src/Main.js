              ...
              return (
                <tr>
                  ...
                  <td>
                    {notice.title}
                    {notice.new == 1 ? (
                      <Image src="https://gpa.ac.in/new.gif"></Image>
                    ) : (
                      ""
                    )}
                  </td>
                  ...
                  <td><icons.PencilFill size={20} color="royalblue" className="align-center"/></td>
                  <td><icons.Trash3Fill size={20} color="red" className="align-center"/></td>
                </tr>
              );
            })
          }
